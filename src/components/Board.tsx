        ...
        {board.map((row, r) =>
          row.map((tile, c) => {
            ...
            const getCellClasses = () => {
              ...
              return isDarkSquare ? 'gap-1 bg-gray-700' : 'bg-gray-700';
            };
            ...
            return (
              <div
                ...
                className={`flex gap-1 items-center justify-center rounded-lg transition-colors ${tileSizeClass} ${getCellClasses()}`}
