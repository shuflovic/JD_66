...
const Tile: React.FC<TileProps> = ({ 
  ...
  return (
    <div 
      className={`flex items-center justify-center rounded-lg shadow-md border-4 ${sizes.container} ${colorClass.bg} ${colorClass.border} ${selectedClasses} ${discardClasses} ${ghostClasses} ${clickableClasses}`}
