        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center space-x-4 border-l border-gray-600 pl-3">
            ...
            <button
              ...
              className="text-gray-500 border-l border-gray-600 pl-3 hover:text-cyan-500 disabled:text-gray-300 dark:text-gray-400 dark:hover:text-cyan-400 dark:disabled:text-gray-600 transition-colors disabled:cursor-not-allowed"
              >
