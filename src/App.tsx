...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full max-w-xl flex flex-col items-center justify-between p-4 space-y-4 bg-gray-900"> 
      <HowToPlayModal 
      ...
      <header className="w-full flex justify-between items-center p-4 bg-gray-800 rounded-xl shadow-md">
        ...
        <button
              ...
              className="pl-2 text-gray-400 hover:text-cyan-400 disabled:text-gray-600 transition-colors disabled:cursor-not-allowed"
              >
        ...
        <div className="w-full max-w-lg flex justify-around items-center p-2 bg-gray-800 rounded-xl shadow-lg">
            ...
            <div className="flex items-center gap-4">
                <button
                    ...
                    className={`p-1 rounded-lg transition-colors ${isSoundOn ? 'text-cyan-400 hover:bg-gray-700' : 'text-gray-500 hover:bg-gray-700'}`}
                >
                    {isSoundOn ? (
                ...
                <div className="flex items-center space-x-2">
                    <span className="text-sm font-medium text-gray-300 hidden sm:inline" id="show-hints-label">Show Hints</span>
                    <button
