...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-900 via-amber-800 to-amber-950 flex flex-col items-center justify-between p-4 space-y-4">
      ...
      <header className="w-full flex justify-between items-center text-amber-300 p-4 bg-amber-950 rounded-lg shadow-2xl border-4 border-amber-700">
      ...
      <main ref={boardRef} className="flex-grow flex items-center justify-center">
        {board.length > 0 && (
          <div className="shadow-2xl border-8 border-amber-950 p-4" style={{background: 'linear-gradient(135deg, #78350f 0%, #92400e 50%, #78350f 100%)'}}>
            <Board 
              board={board} 
      ...
      <footer className="w-full flex flex-col items-center space-y-2">
        ...
        />
        <div className="w-full max-w-lg flex justify-around items-center p-4 bg-amber-950 rounded-lg shadow-xl border-4 border-amber-700">
